...
const MapData_1 = __importDefault(require("../../obj/MapData"));
const component = vue_1.default.extend({
    ...
    methods: {
        _getCtx() {
            const canvas = this.$el.getElementsByClassName("canvas")[0];
        ...
        drawLines() {
            ...
            for (let i = 0; i <= col * 2; i += 1) {
                ...
                ctx === null || ctx === void 0 ? void 0 : ctx.moveTo(x, 0);
                ctx === null || ctx === void 0 ? void 0 : ctx.lineTo(x, height);
                ctx === null || ctx === void 0 ? void 0 : ctx.setLineDash([]);
                ctx.lineWidth = 2;
                if (i == 0 || i == col * 2) {
                    ctx.lineWidth = 4;
                }
                if (i % 2 == 1) {
                    // 虚线
                    ctx === null || ctx === void 0 ? void 0 : ctx.setLineDash([5, 5]);
                }
            ...
            for (let j = 0; j <= row * 2; j += 1) {
                let y = j * (pad / 2);
                ctx === null || ctx === void 0 ? void 0 : ctx.beginPath();
                ctx === null || ctx === void 0 ? void 0 : ctx.moveTo(0, y);
                ctx === null || ctx === void 0 ? void 0 : ctx.lineTo(width, y);
                ctx === null || ctx === void 0 ? void 0 : ctx.setLineDash([]);
                ctx.lineWidth = 2;
                if (j == 0 || j == row * 2) {
                    ctx.lineWidth = 4;
        ...
        drawSelected() {
            ...
            Object.keys(this.mapData.data).forEach(k => {
                ...
                let x = xIndex * (pad / 2);
                let y = yIndex * (pad / 2);
                ctx === null || ctx === void 0 ? void 0 : ctx.fillRect(x, y, pad, pad);
